...
\begin{tabular}{|m{3cm}|m{2cm}|m{11cm}|}
    ...
    \textbf{x} & image-x-offset   & x-offset into the referenced image in screen coordinates \\
    \textbf{y} & image-y-offset   & y-offset into the referenced image in screen coordinates \\
    \textbf{w} & image-width      & width of the referenced image in screen coordinates \\
    \textbf{h} & image-height     & height of the referenced image in screen coordinates \\
    ...
    \textbf{L} & screen-layer     & image layer: 0 (Below text), 1 (Replace text, default), 2 (Above text) \\
    \hline
\end{tabular}
